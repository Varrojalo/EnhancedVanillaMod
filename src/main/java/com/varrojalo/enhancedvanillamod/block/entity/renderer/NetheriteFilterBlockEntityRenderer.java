...
public class NetheriteFilterBlockEntityRenderer implements BlockEntityRenderer<NetheriteFilterBlockEntity> {
    double translateX =  0D;
    double translateZ = 0D;
    float rotation = 0;
    public NetheriteFilterBlockEntityRenderer(BlockEntityRendererProvider.Context context){

    }
    @Override
    public void render(NetheriteFilterBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
