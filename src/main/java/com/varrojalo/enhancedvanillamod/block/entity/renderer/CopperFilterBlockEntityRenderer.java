...
public class CopperFilterBlockEntityRenderer implements BlockEntityRenderer<CopperFilterBlockEntity> {
    double translateX =  0D;
    double translateZ = 0D;
    float rotation = 0;
    public CopperFilterBlockEntityRenderer(BlockEntityRendererProvider.Context context){

    }
    @Override
    public void render(CopperFilterBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
